...
ALLOWED_FILE_TYPES = config('ALLOWED_FILE_TYPES', default='pdf,doc,docx,txt,xls,xlsx,png,jpg,jpeg').split(',')

# Multi-tenancy settings
TENANT_UNIQUENESS = config('TENANT_UNIQUENESS', default='global')  # global or per_tenant
